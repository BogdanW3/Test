...
public class TeapotTile extends DefaultTile
{
	...
	public void read(NBTTagCompound compound)
	{
		...
		//logger.info("Read TeapotTile data from NBT:" + this.modelname + " + " + this.texturename);
	}
	...
	public NBTTagCompound write(NBTTagCompound compound)
	{
		...
		//logger.info("Wrote TeapotTile data to NBT:" + names.getString("modelname") + " + " + names.getString("texturename"));
		return compound;
	}
